...
********************/
// Source Text
const sourceText = "The little cat found a shiny key in the garden. Curious, it followed a trail of tiny footprints to a hidden door under a tree. When it opened the door, it discovered a cozy room filled with warm light and soft pillows, and decided it was the perfect new home."
...
const findSearchTermInTokenizedText = (term, color) =>
{
    ...
    for (let i = 0; i < tokenizedText.length; i++)
    {
        ...
        if(tokenizedText[i] ===term){
           ...
           // call drawCube function 100 times using converted hieght value
           for(let a = 0; a < 100; a++)
           {
